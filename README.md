...
Use the link icon in the calculator panel to copy a unique URL with the current inputs encoded in the link. Share that link with another team so they can open the same current-state or planning inputs in their browser.
